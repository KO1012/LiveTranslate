...
from providers.openai_compatible import make_openai_client
        ...
        try:
            ...
            for i, text in enumerate(sentences):
                ...
                try:
                    ...
                    chunks = []
                    for chunk in stream:
                        # Some OpenAI-compatible servers emit keep-alive/usage
                        # chunks with an empty choices list; skip them instead of
                        # indexing [0] (which would raise and wrongly fall back
                        # to a second non-streaming request, corrupting timing).
